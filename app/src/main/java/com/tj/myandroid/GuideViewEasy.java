 ...
 */
public class GuideViewEasy extends RelativeLayout implements ViewTreeObserver.OnGlobalLayoutListener {
    ...
    public GuideViewEasy(Context context) {
        super(context);
    ...
    public static class Builder {
        static GuideViewEasy guiderView;
        ...
        public static Builder newInstance(Context ctx) {
            guiderView = new GuideViewEasy(ctx);
            return instance;
        }
